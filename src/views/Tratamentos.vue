<template>
  <div class="container-fluid py-4">
    <pro-calendar :events="evts" :loading="false" :config="cfg" view="month" date="2024-05-04T00:00:00.000Z"
      @calendarClosed="void 0" @fetchEvents="void 0" />
    <div class="row">
      <div class="col-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-success shadow-success border-radius-lg p-2">
              <h6 class="text-white text-capitalize ps-3">Tratamentos</h6>
            </div>
          </div>
