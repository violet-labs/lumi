<template>
  <div class="container-fluid pb-4">
    <div class="row">
      <div class="col-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n2 mx-2 z-index-2">
            <div
              class="bg-gradient-success shadow-success border-radius-lg pt-3 pb-1"
            >
              <h6 class="text-white text-capitalize ps-3">Sexta-Feira, 28 de Abril de 2024</h6>
            </div>
          </div>
...
const data = "2023-11-10T00:00:00.000Z"
